        ...
        <div class="container clearfix">
            <div class="row">
                <div class="col-sm-5 "><!--Left column-->
                    <img class=" img-responsive img-center" src="assets/img/test-wordpress-logo.png" alt="Bootstrap To WordPress">
                </div><!--End Left column----->
...
<section id="whatIsWordpress" class="section-padding">
    ...
    <div class="container">
        <div class="section-header">
            <img class=" img-responsive img-center" src="assets/img/Wordpress-logo.png" alt="Wordpress logo">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-4 ">
                ...
                <img class="img-responsive img-center" style="width: 150px" src="assets/img/Responsive-Web-Design-compressor.png">
                </div>
            ...
            <div class="col-sm-4 ">
                <div class="features-img-boxes">
                <img class="img-responsive img-center"style="height: 110px" src="assets/img/premium-quality.png">
                </div>
            ...
            <div class="col-sm-4 ">
                ...
                <img class="img-responsive img-center" style="width: 300px;" src="assets/img/Wordpress-logo.png">
                </div>
